...
document.addEventListener("DOMContentLoaded", () => {
  ...
  categories.map((category) => {
    ...
    btn.addEventListener('click', (event) => {
      ...
      const filtered = menu.filter (item => item.category === category || category === "All")

      filtered.map(item => sectionContainer.appendChild(show(item)))
    })
...
menu.map(item => sectionContainer.appendChild(show(item)))
